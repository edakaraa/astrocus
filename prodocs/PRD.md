...
| T-18 | Uygulama revizyonu: takımyıldızı kartları, 2 ✦/dk, manuel unlock, 4 slayt onboarding | §3.3, §4.2–§4.3, §4.10 |
...
| Yıldız tozu ekonomisi | 10 ✦/dk temel + saat dilimi kategori bonusu | **2 ✦/dk**; streak + duraklatmadan tamamlama bonusu (RPC); saat dilimi bonusu v1.1 adayı |
