...
- 13 burç takımyıldızı, toplam 67 gök cismi; sıralı manuel unlock ile kişisel gökyüzü inşası
...
| Takımyıldızı kartları   | 13 burç; takımyıldızı başına 4–7 yıldız (toplam 67)      | `constellations`, `GalaxyScreen`            |
...
| [galaxy-catalog.md](./galaxy-catalog.md)    | Yıldız kataloğu (67 gök cismi)                |
