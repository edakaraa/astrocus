-- Raise daily goal cap from 240 to 500 minutes.
...
alter table public.daily_goal_entries
  ...
  check (goal_minutes >= 15 and goal_minutes <= 500);
...
begin
  ...
  if p_goal_minutes is null or p_goal_minutes < 15 or p_goal_minutes > 500 then
